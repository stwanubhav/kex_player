...
(function() {
    ...
    // Speed setting
    speedSetting.addEventListener('click', function() {
    ...
    // Auto next
    autoNextSetting.addEventListener('click', function() {
    ...
    function init() {
        ...
        // Build quality options from config
